...
<html>
    ...
    <article role="main" ng-controller="mainCtrl">
      ...
      <section>
        ...
        <div class="hcont">
          ...
          <h2 class="editable" ng-model="viewStrings['pageTitle']" single-line="true" edit-callback="saveStrings" content-editable></h2>
          ...
          <p class="editable" ng-model="viewStrings['classParagraph']" focus-select="true" edit-callback="saveStrings" content-editable>
            All the elements with the directive will get the <b>editable</b> class by default, you can specify your own class with the <b>editable-class</b> attribute.
          </p>

          <p class="editable" ng-model="viewStrings['firstParagraph']" focus-select="true" edit-callback="saveStrings" content-editable>
          ...
          <p class="editable" ng-model="viewStrings['secondParagraph']" edit-callback="saveStrings" render-html="true" content-editable>
          ...
          <p ng-model="paragraphCallback" single-line="true" edit-callback="exitCallback" content-editable>
  ...
  <script type="text/javascript" src="../test/vendor/angular.min.js"></script>
  ...
  <script>
    ...
    angular.module('app', [
      ...
      $scope.saveStrings = function(text,elem) {
        $localStorage.setObject('exampleStrings', $scope.viewStrings)
      }
  ...
  <script type="text/javascript" src="../dist/content-editable.directive.min.js"></script>
</html>
