...
return
    ...
    [
         ...
         */
        'siteId' => env('ANALYTICS_SITE_ID', 'ga:148172183'),
         ...
         */
        'clientId' => env('ANALYTICS_CLIENT_ID', 'phuket-pearl-dashboard@phuket-pearl.iam.gserviceaccount.com'),
         ...
         */
        'serviceEmail' => env('ANALYTICS_SERVICE_EMAIL', 'phuket-pearl-dashboard@phuket-pearl.iam.gserviceaccount.com'),

        /*
         * You need to download a p12-certifciate from the Google API console
         * Be sure to store this file in a secure location.
         */
        'certificatePath' => storage_path('app/laravel-analytics/PhuketPearl-f67acdcb65c8.p12'),
