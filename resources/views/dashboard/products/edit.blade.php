                    ...
                    <header class="panel-heading">
						<div class="row">
							<div class="col-sm-12">
								...
								<a href="/dashboard/products/{{$product->productid}}/quality" class="btn btn-danger btn-sm pull-right">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal tasi-form" method="post" action="{{$request->fullUrl()}}" name="form" id="form">
                                ...
                                <div class="col-sm-9">
									<div class="checkboxes">
                                        ...
                                        <label class="label_check c_on">
											<input name="category[]" value="{{$category->categoryid}}" type="checkbox" data-plugin="icheck" @if($product->hasCategory($category->categoryid)) checked @endif> <span class="ui-icheck-text">{{$category->getTitle($config['lang']['code'])}}</span>
										</label>
                                        @endforeach
									</div>
								</div>
                                    ...
                                    <div>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div role="tabpanel" class="tab-pane ui-tab-pane @if($index == 0) active @endif" id="title-{{$locale['code']}}">
                                                <input type="text" class="form-control" name="title[{{$locale['code']}}]" autocomplete="off" data-input-title="{{$locale['code']}}" value="{!! $product->getTitle($locale['code']) !!}">
                                            </div>
                                            @endforeach
                                        </div>
                                    </div>
                            ...
                            <div class="form-group" data-group="code">
                                <label class="col-sm-3 control-label">{{trans('product.Code')}}</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="code" maxlength="50" autocomplete="off" value="{!! $product->code !!}">
								</div>
                            </div>
							...
							<div class="form-group" data-group="url">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="url" maxlength="128" autocomplete="off" value="{!! $product->url !!}">
									<p class="help-block">
                                    ...
                                    <div>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div role="tabpanel" class="tab-pane ui-tab-pane @if($index == 0) active @endif" id="pearltype-{{$locale['code']}}">
                                                <textarea placeholder="({{trans('_.optional')}})" class="form-control" name="pearltype[{{$locale['code']}}]" data-input-pearltype="{{$locale['code']}}" data-plugin="autosize" style="max-width:100%;">{!! $product->getPearltype($locale['code']) !!}</textarea>
                                            </div>
                                            @endforeach
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div role="tabpanel" class="tab-pane ui-tab-pane @if($index == 0) active @endif" id="bodytype-{{$locale['code']}}">
                                                <textarea placeholder="({{trans('_.optional')}})" class="form-control" name="bodytype[{{$locale['code']}}]" placeholder="" data-input-bodytype="{{$locale['code']}}" data-plugin="autosize" style="max-width:100%;">{!! $product->getBodytype($locale['code']) !!}</textarea>
                                            </div>
                                            @endforeach
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div role="tabpanel" class="tab-pane ui-tab-pane @if($index == 0) active @endif" id="pearlsize-{{$locale['code']}}">
                                                <textarea placeholder="({{trans('_.optional')}})" class="form-control" name="pearlsize[{{$locale['code']}}]" data-input-pearlsize="{{$locale['code']}}" data-plugin="autosize" style="max-width:100%;">{!! $product->getPearlsize($locale['code']) !!}</textarea>
                                            </div>
                                            @endforeach
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div role="tabpanel" class="tab-pane ui-tab-pane @if($index == 0) active @endif" id="materials-{{$locale['code']}}">
                                                <textarea placeholder="({{trans('_.optional')}})" class="form-control" name="materials[{{$locale['code']}}]" placeholder="" data-input-materials="{{$locale['code']}}" data-plugin="autosize" style="max-width:100%;">{!! $product->getMaterials($locale['code']) !!}</textarea>
                                            </div>
                                            @endforeach
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div role="tabpanel" class="tab-pane ui-tab-pane @if($index == 0) active @endif" id="moredetails-{{$locale['code']}}">
                                                <textarea placeholder="({{trans('_.optional')}})" class="form-control" name="moredetails[{{$locale['code']}}]" data-input-moredetails="{{$locale['code']}}" data-plugin="autosize" style="max-width:100%;">{!! $product->getMoredetails($locale['code']) !!}</textarea>
                                            </div>
                                            @endforeach
                                        </div>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="keywords" class="form-control" placeholder="({{trans('_.optional')}})" autocomplete="off" id="ipt-keywords" value="{!! $keywords !!}">
								</div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
									<label class="checkbox-inline" style="padding-left:0px;">
                                		<input type="radio" name="publish" value="yes" data-plugin="icheck" @if($product->publish == '1') checked @endif> {{trans('_.Yes')}}
									</label>
									<label class="checkbox-inline">
                                		<input type="radio" name="publish" value="no" data-plugin="icheck" @if($product->publish == '0') checked @endif> {{trans('_.No')}}
									</label>
								</div>
                            </div>
