                    ...
                    <header class="panel-heading">
						<div class="row">
							<div class="col-sm-12">
								...
								<span class="ui-head">{{trans('slide.Add New Slide')}}</span>
							</div>
						</div>
                    </header>
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal tasi-form" method="post" action="{{$request->fullUrl()}}" name="form" id="form">
							...
							<div class="form-group" data-group="link">
                                ...
                                <div class="col-sm-9">
									<textarea placeholder="({{trans('_.optional')}})" class="form-control" rows="1" name="link" data-plugin="autosize" style="max-width: 100%;"></textarea>
									<p class="help-block">
							...
							<div class="form-group">
                                <label class="col-sm-3 control-label">{{trans('slide.Add to')}}</label>
                                <div class="col-sm-4">
									<select class="form-control" name="addto">
										<option value="last" selected="">{{trans('slide.Last slide')}}</option>
										<option value="first">{{trans('slide.First slide')}}</option>
									</select>
								</div>
                            </div>
