                ...
                <section class="panel">
                    <header class="panel-heading">
						<div class="row">
							<div class="col-md-6">
								...
								<span class="ui-head">{{trans('news.Write News')}}</span>
							</div>
                            <div class="col-md-6">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal tasi-form" method="post" action="{{$request->fullUrl()}}" name="form" enctype="multipart/form-data" id="form">
                                    ...
                                    <div>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div role="tabpanel" class="tab-pane ui-tab-pane @if($index == 0) active @endif" id="topic-{{$locale['code']}}">
                                                <input type="text" class="form-control" name="topic[{{$locale['code']}}]" maxlength="256" autocomplete="off" data-input-topic="{{$locale['code']}}">
                                            </div>
                                            @endforeach
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div role="tabpanel" class="tab-pane ui-tab-pane @if($index == 0) active @endif" id="description-{{$locale['code']}}">
                                                <input type="text" class="form-control" name="description[{{$locale['code']}}]" maxlength="256" autocomplete="off" data-input-description="{{$locale['code']}}">
                                            </div>
                                            @endforeach
                                        </div>
                                    </div>
									...
									<div class="row">
										<div class="col-md-4">
											<div class="input-group">
												<input type="text" class="form-control" aria-describedby="basic-addon1" readonly="" style="background-color: #fff; cursor: pointer;" id="published">
                                    ...
                                    <div>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div role="tabpanel" class="tab-pane ui-tab-pane @if($index == 0) active @endif" id="content-{{$locale['code']}}">
                                                <div class="ui-editor">
                                                    <textarea data-plugin="froala-editor" name="content[{{$locale['code']}}]"></textarea>
							...
							<input type="hidden" name="published" id="published-input">
