                ...
                <section class="panel">
                    <header class="panel-heading">
						<div class="row">
							<div class="col-md-6">
								...
								<span class="ui-head">{{trans('tour.Create New Package')}}</span>
							</div>
                            <div class="col-md-6">
								<form class="form-inline pull-right pull-left-sm" role="form" method="get" action="{{$request->fullUrl()}}">
									<button type="button" class="btn btn-danger btn-sm" id="create">
										{{trans('_.Create')}}
									</button>
								</form>
							</div>
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal tasi-form" method="post" action="{{$request->fullUrl()}}" name="form" id="form">
                                ...
                                <div class="col-sm-10">
									<div class="checkboxes">
                                        <label class="label_check c_on">
											<input name="about_new" value="true" type="checkbox" data-plugin="icheck"> <span class="ui-icheck-text">{{trans('tour.New package')}}</span>
										</label>
                                        <label class="label_check c_on">
											<input name="about_popular" value="true" type="checkbox" data-plugin="icheck"> <span class="ui-icheck-text">{{trans('tour.Popular package')}}</span>
										</label>
                                        <label class="label_check c_on">
											<input name="about_recommend" value="true" type="checkbox" data-plugin="icheck"> <span class="ui-icheck-text">{{trans('tour.Recommended package')}}</span>
										</label>
									</div>
								</div>
                            </div>
                            ...
                            <div class="form-group" data-group="price_type">
                                ...
                                <div class="col-sm-10">
                                    <label class="checkbox-inline" style="padding-left:0px;">
                                		<input type="radio" name="price_type" value="person" data-plugin="icheck-price" checked> {{trans('tour.Single ticket')}}
									</label>
									<label class="checkbox-inline">
                                		<input type="radio" name="price_type" value="package" data-plugin="icheck-price"> {{trans('tour.Bundle ticket')}}
									</label>
									<label class="checkbox-inline">
                                		<input type="radio" name="price_type" value="free" data-plugin="icheck-price"> {{trans('tour.Free Transfer ticket')}}
									</label>
								</div>
                            </div>

                            <div class="form-group" data-group="price_per_person">
                                <label class="col-sm-2 control-label">{{trans('_.Price')}}</label>
                                <div class="col-sm-6">
                                    <div class="input-group m-bot15">
                                        <span class="input-group-addon">{{trans('_.Adult')}}</span>
                                        <input type="text" name="price_person_adult" class="form-control" placeholder="" data-plugin="price">
                                        <span class="input-group-addon">THB</span>
                                    </div>

                                    <div class="input-group">
                                        <span class="input-group-addon">{{trans('_.Child')}}</span>
                                        <input type="text" name="price_person_child" class="form-control" placeholder="" data-plugin="price">
                                        <span class="input-group-addon">THB</span>
                                    </div>
								</div>
                            </div>

                            <div class="form-group" data-group="price_per_package" style="display:none;">
                                <label class="col-sm-2 control-label">{{trans('_.Price')}}</label>
                                <div class="col-sm-6">
                                    <div class="input-group m-bot15">
                                        <input type="text" name="price_package" class="form-control" data-plugin="price">
                                        <span class="input-group-addon">THB</span>
                                    </div>

                                    <div class="input-group m-bot15">
                                        <span class="input-group-addon">{{trans('tour.Number of adult and child')}}</span>
                                        <input type="text" name="number_package_adult" class="form-control" placeholder="" data-plugin="number">
                                    </div>

                                    <div class="input-group hidden">
                                        <span class="input-group-addon">{{trans('tour.Number of child')}}</span>
                                        <input type="text" name="number_package_child" class="form-control" placeholder="" data-plugin="number" value="0">
                                    </div>
								</div>
                            </div>

							<div class="form-group" ng-class="{'has-error': extraError}" data-group="price_per_package" style="display:none;">
							...
							<div class="form-group" data-group="price_free">
                                <label class="col-sm-2 control-label">{{trans('tour.Maximum guests')}}</label>
                                <div class="col-sm-6">
                                    <div class="input-group">
										<input type="text" name="maximum_guests" class="form-control" placeholder="" data-plugin="number">
                            ...
                            <div class="form-group payments">
                                ...
                                <div class="col-sm-10">
									<div class="checkboxes">
                                        ...
                                        <label class="label_check c_on">
											<input name="payments[]" value="{{$payment->paymentid}}" type="checkbox" data-plugin="icheck" checked>
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-10">
									<label class="checkbox-inline" style="padding-left:0px;">
                                		<input type="radio" name="show_child_age" value="yes" data-plugin="icheck" checked> {{trans('_.Yes')}}
									</label>
									<label class="checkbox-inline">
                                		<input type="radio" name="show_child_age" value="no" data-plugin="icheck"> {{trans('_.No')}}
									</label>
								</div>
                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div role="tabpanel" class="tab-pane ui-tab-pane @if($index == 0) active @endif" id="detail-{{$locale['code']}}">
                                                <div class="ui-editor">
                                                    <textarea data-plugin="froala-editor" name="detail[{{$locale['code']}}]"></textarea>
                                ...
                                <div class="col-sm-10">
									<div class="row">
										<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
											<label class="checkbox-inline" style="padding-left:0px;">
												<input type="checkbox" name="disabled_week[]" value="0" data-plugin="icheck"> &nbsp; {{trans('_.Sunday')}}
											</label>
										</div>
										<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
											<label class="checkbox-inline" style="padding-left:0px;">
		                                		<input type="checkbox" name="disabled_week[]" value="1" data-plugin="icheck"> &nbsp; {{trans('_.Monday')}}
											</label>
										</div>
										<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
											<label class="checkbox-inline" style="padding-left:0px;">
		                                		<input type="checkbox" name="disabled_week[]" value="2" data-plugin="icheck"> &nbsp; {{trans('_.Tuesday')}}
											</label>
										</div>
										<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
											<label class="checkbox-inline" style="padding-left:0px;">
		                                		<input type="checkbox" name="disabled_week[]" value="3" data-plugin="icheck"> &nbsp; {{trans('_.Wednesday')}}
											</label>
										</div>
										<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
											<label class="checkbox-inline" style="padding-left:0px;">
		                                		<input type="checkbox" name="disabled_week[]" value="4" data-plugin="icheck"> &nbsp; {{trans('_.Thursday')}}
											</label>
										</div>
										<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
											<label class="checkbox-inline" style="padding-left:0px;">
		                                		<input type="checkbox" name="disabled_week[]" value="5" data-plugin="icheck"> &nbsp; {{trans('_.Friday')}}
											</label>
										</div>
										<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
											<label class="checkbox-inline" style="padding-left:0px;">
		                                		<input type="checkbox" name="disabled_week[]" value="6" data-plugin="icheck"> &nbsp; {{trans('_.Saturday')}}
											</label>
										</div>
									</div>
								</div>
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-10">
									<div class="row">
										<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
											<label class="checkbox-inline" style="padding-left:0px;">
		                                		<input type="checkbox" name="disabled_month[]" value="1" data-plugin="icheck"> &nbsp; {{trans('_.January')}}
											</label>
										</div>
										<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
											<label class="checkbox-inline" style="padding-left:0px;">
		                                		<input type="checkbox" name="disabled_month[]" value="2" data-plugin="icheck"> &nbsp; {{trans('_.February')}}
											</label>
										</div>
										<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
											<label class="checkbox-inline" style="padding-left:0px;">
		                                		<input type="checkbox" name="disabled_month[]" value="3" data-plugin="icheck"> &nbsp; {{trans('_.March')}}
											</label>
										</div>
										<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
											<label class="checkbox-inline" style="padding-left:0px;">
		                                		<input type="checkbox" name="disabled_month[]" value="4" data-plugin="icheck"> &nbsp; {{trans('_.April')}}
											</label>
										</div>
										<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
											<label class="checkbox-inline" style="padding-left:0px;">
		                                		<input type="checkbox" name="disabled_month[]" value="5" data-plugin="icheck"> &nbsp; {{trans('_.May')}}
											</label>
										</div>
										<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
											<label class="checkbox-inline" style="padding-left:0px;">
		                                		<input type="checkbox" name="disabled_month[]" value="6" data-plugin="icheck"> &nbsp; {{trans('_.June')}}
											</label>
										</div>
										<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
											<label class="checkbox-inline" style="padding-left:0px;">
		                                		<input type="checkbox" name="disabled_month[]" value="7" data-plugin="icheck"> &nbsp; {{trans('_.July')}}
											</label>
										</div>
										<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
											<label class="checkbox-inline" style="padding-left:0px;">
		                                		<input type="checkbox" name="disabled_month[]" value="8" data-plugin="icheck"> &nbsp; {{trans('_.August')}}
											</label>
										</div>
										<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
											<label class="checkbox-inline" style="padding-left:0px;">
		                                		<input type="checkbox" name="disabled_month[]" value="9" data-plugin="icheck"> &nbsp; {{trans('_.September')}}
											</label>
										</div>
										<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
											<label class="checkbox-inline" style="padding-left:0px;">
		                                		<input type="checkbox" name="disabled_month[]" value="10" data-plugin="icheck"> &nbsp; {{trans('_.October')}}
											</label>
										</div>
										<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
											<label class="checkbox-inline" style="padding-left:0px;">
		                                		<input type="checkbox" name="disabled_month[]" value="11" data-plugin="icheck"> &nbsp; {{trans('_.November')}}
											</label>
										</div>
										<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
											<label class="checkbox-inline" style="padding-left:0px;">
		                                		<input type="checkbox" name="disabled_month[]" value="12" data-plugin="icheck"> &nbsp; {{trans('_.December')}}
											</label>
										</div>
									</div>
								</div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="map" style="resize: none;" data-plugin="autosize" placeholder="({{trans('_.optional')}})"></textarea>
                                    ...
                                    <div>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div role="tabpanel" class="tab-pane ui-tab-pane @if($index == 0) active @endif" id="note-{{$locale['code']}}">
                                                <textarea class="form-control" name="note[{{$locale['code']}}]" placeholder="({{trans('_.optional')}})" data-input-note="{{$locale['code']}}" data-plugin="autosize" style="max-width:100%;"></textarea>
                                            </div>
                                            @endforeach
                                        </div>
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="keywords" placeholder="({{trans('_.optional')}})" class="form-control" autocomplete="off" id="ipt-keywords">
								</div>
                            </div>
