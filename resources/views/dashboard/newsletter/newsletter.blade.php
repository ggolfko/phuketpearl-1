        ...
        <table align="center" width="600" class="email-container" ng-class="{'ui-hidden':!parent.blocks.section1}">
			<tr>
				<td style="padding: 20px 0; text-align: center">
                    ...
                    @else
                        <img src="{!! config('app.url') . "//app/newsletter/draft/{$draft->draftid}/{$draft->images_section1_0}.png" !!}" width="140" height="70" border="0">
                    @endif
				</td>
			</tr>
        </table>
        ...
        <table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" width="600" class="email-container">
            ...
            <tr>
				<td>
                    ...
                    @else
                    <img src="{!! config('app.url') . "/app/newsletter/draft/{$draft->draftid}/{$draft->images_section2_0}.jpg" !!}" width="100%" height="" border="0" align="center" style="width: 100%; max-width: 100%;">
                    @endif
				</td>
            </tr>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" align="center" style="Margin: auto">
                        <tr>
                            <td style="border-radius: 3px; background: #222222; text-align: center;" class="button-td">
                                <a href="{!! $draft->buttons_section3_0_link !!}" target="_blank" style="background: #222222; border: 15px solid #222222; font-family: sans-serif; font-size: 13px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-a">
            ...
            <tr>
                ...
                @else
                <td bgcolor="#222222" valign="middle" style="text-align: center; background-position: center center !important; background-size: cover !important; background-image: url('{!! config('app.url') . "/app/newsletter/draft/{$draft->draftid}/{$draft->images_section4_0}.jpg" !!}')">
                @endif
                    <div>
                                ...
                                <table cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        <td style="padding: 10px; text-align: center">
                                            ...
                                            @else
                                            <img src="{!! config('app.url') . "/app/newsletter/draft/{$draft->draftid}/{$draft->images_section5_0}.jpg" !!}" width="270" height="270" border="0" class="fluid">
                                            @endif
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <table cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        <td style="padding: 10px; text-align: center">
                                            ...
                                            <img src="http://placehold.it/270" width="270" height="270" border="0" class="fluid">
                                            @else
                                            <img src="{!! config('app.url') . "/app/newsletter/draft/{$draft->draftid}/{$draft->images_section5_1}.jpg" !!}" width="270" height="270" border="0" class="fluid">
                                            @endif
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <table cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        <td style="padding: 10px; text-align: center">
                                            ...
                                            @else
                                            <img src="{!! config('app.url') . "/app/newsletter/draft/{$draft->draftid}/{$draft->images_section6_0}.jpg" !!}" width="170" height="170" border="0" class="fluid">
                                            @endif
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <table cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        <td style="padding: 10px; text-align: center">
                                            ...
                                            <img src="http://placehold.it/170" width="170" height="170" border="0" class="fluid">
                                            @else
                                            <img src="{!! config('app.url') . "/app/newsletter/draft/{$draft->draftid}/{$draft->images_section6_1}.jpg" !!}" width="170" height="170" border="0" class="fluid">
                                            @endif
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <table cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        <td style="padding: 10px; text-align: center">
                                            ...
                                            <img src="http://placehold.it/170" width="170" height="170" border="0" class="fluid">
                                            @else
                                            <img src="{!! config('app.url') . "/app/newsletter/draft/{$draft->draftid}/{$draft->images_section6_2}.jpg" !!}" width="170" height="170" border="0" class="fluid">
                                            @endif
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td dir="ltr" valign="top" style="padding: 10px 10px;">
                                            ...
                                            @else
                                            <img src="{!! config('app.url') . "/app/newsletter/draft/{$draft->draftid}/{$draft->images_section7_0}.jpg" !!}" width="170" width="170" border="0" class="center-on-narrow">
                                            @endif
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        <td dir="ltr" valign="top" style="font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555; padding: 10px; text-align: left;" class="center-on-narrow">
                                            ...
                                            <table cellspacing="0" cellpadding="0" border="0" class="center-on-narrow" style="float:left;">
                                                <tr>
                                                    <td style="border-radius: 3px; background: #222222; text-align: center;" class="button-td">
                                                        <a href="{!! $draft->buttons_section7_0_link !!}" target="_blank" style="background: #222222; border: 15px solid #222222; font-family: sans-serif; font-size: 13px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-a">
                                ...
                                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td dir="ltr" valign="top" style="padding: 10px 10px;">
                                            ...
                                            <img src="http://placehold.it/170" width="170" width="170" border="0" class="center-on-narrow">
                                            @else
                                            <img src="{!! config('app.url') . "/app/newsletter/draft/{$draft->draftid}/{$draft->images_section8_0}.jpg" !!}" width="170" width="170" border="0" class="center-on-narrow">
                                            @endif
                                        </td>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        <td dir="ltr" valign="top" style="font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555; padding: 10px; text-align: left;" class="center-on-narrow">
                                            ...
                                            <table cellspacing="0" cellpadding="0" border="0" class="center-on-narrow" style="float:left;">
                                                <tr>
                                                    <td style="border-radius: 3px; background: #222222; text-align: center;" class="button-td">
                                                        <a href="{!! $draft->buttons_section8_0_link !!}" target="_blank" style="background: #222222; border: 15px solid #222222; font-family: sans-serif; font-size: 13px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-a">
            ...
            <table border="0" cellpadding="0" cellspacing="0" id="canspamBar">
                <tr>
                    <td align="center" valign="top" style="color:#606060; font-family:Helvetica, Arial, sans-serif; font-size:11px; line-height:150%; padding-right:20px; padding-bottom:5px; padding-left:20px; text-align:center;">
                        <span style="color: #555555;">This email was sent to</span> <a href="mailto:*|EMAIL|*" target="_blank" style="color:#404040 !important;">*|EMAIL|*</a>
                        <br/>
                        ...
                        <br/>
						<p style="max-width: 500px; text-align: center; margin: 0 auto; margin-top: 8px;">
							<span class="mobile-link--footer" style="color: #555555;">{{$address}}</span> <span style="padding-left: 9px; padding-right: 5.5px; font-size: 14px; color: #555555;">|</span> <span class="mobile-link--footer" style="color: #555555;">{{implode(', ', $phones)}}</span>
						</p>
                        <br/>
                        *|REWARDS|*
                    </td>
