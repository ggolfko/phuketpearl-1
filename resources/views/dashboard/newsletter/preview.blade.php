...
<html xmlns="http://www.w3.org/1999/xhtml" ng-app="preview">
<head>
...
<script src="/static/dashboard/newsletter/preview/app.js"></script>

</head>
<body bgcolor="#111111" width="100%" style="Margin: 0;" ng-controller="Preview">
<table bgcolor="#111111" cellpadding="0" cellspacing="0" border="0" height="100%" width="100%" style="border-collapse:collapse;"><tr><td valign="top">
    <center style="width: 100%;">
        ...
        <table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" width="600" class="email-container">
            ...
            <tr ng-class="{'ui-hidden': !parent.blocks.section2}">
				<td>
            ...
            <!-- 1 Column Text : BEGIN -->
            <tr ng-class="{'ui-hidden': !parent.blocks.section3}">
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" align="center" style="Margin: auto">
                        <tr>
                            <td style="border-radius: 3px; background: #222222; text-align: center;" class="button-td">
                                <a ng-href="[[(parent.buttons.section3[0].link?parent.buttons.section3[0].link:'')]]" ng-attr-target="[[(parent.buttons.section3[0].link?'_blank':undefined)]]" style="background: #222222; border: 15px solid #222222; font-family: sans-serif; font-size: 13px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-a">
            ...
            <tr ng-class="{'ui-hidden': !parent.blocks.section4}">
                <!-- Bulletproof Background Images c/o https://backgrounds.cm -->
                <td ng-style="{'background-image':parent.images.section4[0]?'url(/app/newsletter/'+parent.images.section4[0]+'.png)':'url(https://placehold.it/600x230/222222/666666)'}" bgcolor="#222222" valign="middle" style="text-align: center; background-position: center center !important; background-size: cover !important;">
                    <div>
            ...
            <tr ng-class="{'ui-hidden': !parent.blocks.section5}">
            ...
            <tr ng-class="{'ui-hidden': !parent.blocks.section6}">
                <td align="center" valign="top" style="padding: 10px;">
                    <table cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <!-- Column : BEGIN -->
            ...
            <tr ng-class="{'ui-hidden': !parent.blocks.section7}">
                                ...
                                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td dir="ltr" valign="top" style="font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555; padding: 10px; text-align: left;" class="center-on-narrow">
                                            <strong style="color:#111111;">[[(parent.text.section7[0]?parent.text.section7[0]:'Class aptent taciti sociosqu')]]</strong>
                                            <br><br>
                                            ...
                                            <table cellspacing="0" cellpadding="0" border="0" class="center-on-narrow" style="float:left;">
                                                <tr>
                                                    <td style="border-radius: 3px; background: #222222; text-align: center;" class="button-td">
                                                        <a ng-href="[[(parent.buttons.section7[0].link?parent.buttons.section7[0].link:'')]]" ng-attr-target="[[(parent.buttons.section7[0].link?'_blank':undefined)]]" style="background: #222222; border: 15px solid #222222; font-family: sans-serif; font-size: 13px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-a">
            ...
            <tr ng-class="{'ui-hidden': !parent.blocks.section8}">
                        ...
                        <tr>
                            ...
                            <td width="66.66%" class="stack-column-center" valign="top">
                                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td dir="ltr" valign="top" style="font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555; padding: 10px; text-align: left;" class="center-on-narrow">
                                            <strong style="color:#111111;">[[(parent.text.section8[0]?parent.text.section8[0]:'Class aptent taciti sociosqu')]]</strong>
                                            <br><br>
                                            ...
                                            <table cellspacing="0" cellpadding="0" border="0" class="center-on-narrow" style="float:left;">
                                                <tr>
                                                    <td style="border-radius: 3px; background: #222222; text-align: center;" class="button-td">
                                                        <a ng-href="[[(parent.buttons.section8[0].link?parent.buttons.section8[0].link:'')]]" ng-attr-target="[[(parent.buttons.section8[0].link?'_blank':undefined)]]" style="background: #222222; border: 15px solid #222222; font-family: sans-serif; font-size: 13px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-a">
