            ...
            <div class="col-lg-12">
                <section class="panel" id="no-more-tables">
                    <header class="panel-heading">
						<div class="row">
							<div class="col-md-12">
                                <a href="/dashboard/gallery" class="btn btn-danger btn-sm" style="margin-right: 10px;">
									<i class="fa fa-chevron-left"></i>
		                            {{trans('_.Back')}}
		                        </a>
                                {{trans('video.Video Management')}}
                                <a href="/dashboard/gallery/videos/add" class="btn btn-danger btn-sm pull-right">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 ui-item" ng-controller="ItemController" ng-mouseenter="visible=true" ng-mouseleave="visible=false">
                                <div class="ui-action" ng-show="visible">
                                    <a href="/dashboard/gallery/videos/{{$item->videoid}}" class="btn btn-xs btn-primary">{{trans('_.Edit')}}</a>
                                ...
                                <a href="{!! $item->youtube !!}" class="fancybox">
                                    ...
                                    <img src="/app/gallery_videos/{{$item->videoid}}/preview.png" class="img-responsive">
                                    @else
    ...
    app.controller('ItemController', function($scope, $http, $window){
        ...
        $scope.delete = function(id, videoid){
            if (confirm('{{trans('_.Are you sure?')}}')){
                ...
                $http.post('/ajax/dashboard/gallery/videos/'+videoid+'/delete', {
                    id: id
                })
