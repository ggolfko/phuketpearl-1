                    ...
                    <header class="panel-heading">
						<div class="row">
							<div class="col-sm-12">
								...
								<span class="ui-head">{{trans('timeline.Add Timeline')}}</span>
							</div>
						</div>
                    </header>
                            ...
                            <div class="form-group" data-group="year">
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group">
                                        <input type="text" name="year" class="form-control" style="background-color:#fff;cursor:pointer;" id="year" readonly>
