            ...
            <div class="col-lg-10">
                <section class="panel">
                    <header class="panel-heading">
						<div class="row">
							<div class="col-sm-12">
								<a href="/dashboard/docs/pearlquality/{{$item->itemid}}" class="btn btn-danger btn-sm">
                        ...
                        <form class="form-horizontal tasi-form" method="post" action="{{$request->fullUrl()}}" name="form" id="form">
                                    ...
                                    <div>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div role="tabpanel" class="tab-pane ui-tab-pane @if($index == 0) active @endif" id="title-{{$locale['code']}}">
                                                <input type="text" class="form-control" name="title[{{$locale['code']}}]" maxlength="128" autocomplete="off" data-input-title="{{$locale['code']}}" value="{{ $item->getTitle($locale['code']) }}">
                                    ...
                                    <div>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div role="tabpanel" class="tab-pane ui-tab-pane @if($index == 0) active @endif" id="details-{{$locale['code']}}">
												<textarea rows="3" name="details[{{$locale['code']}}]" data-input-details="{{$locale['code']}}" class="form-control" data-plugin="autosize" style="resize: none;">{!! $item->getDetails($locale['code']) !!}</textarea>
												<p class="help-block"><em>{{trans('_.Please enter all information in each language.')}}</em></p>
                                            </div>
                                            @endforeach
                                        </div>
							...
							<div class="form-group" data-group="image">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div id="img-preview">
										<img src="/app/pearlquality/{{$item->imageid}}.png" class="img-thumbnail">
									</div>
								</div>
                            </div>
