                    ...
                    <header class="panel-heading">
						<div class="row">
							<div class="col-sm-12">
								...
								<span class="ui-head">{{trans('pearl.Add New')}}</span>
							</div>
						</div>
                    </header>
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-9">
									<label class="checkbox-inline" style="padding-left:0px;">
                                		<input type="radio" name="main" value="yes" data-plugin="icheck" checked> {{trans('_.Yes')}}
									</label>
									<label class="checkbox-inline">
                                		<input type="radio" name="main" value="no" data-plugin="icheck"> {{trans('_.No')}}
									</label>
								</div>
                            </div>
                            <div class="form-group">
