                    ...
                    <header class="panel-heading">
						<div class="row">
							<div class="col-sm-12">
								...
								<span class="ui-head">{{trans('pearl.Edit Slide')}}</span>
							</div>
						</div>
                    </header>
                        ...
                        <form class="form-horizontal tasi-form" method="post" action="{{$request->fullUrl()}}" name="form" id="form">
							<div class="form-group" data-group="image">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    @else
                                    <div id="img-preview">
                                        <img src="/app/pearlfarming/{{$farming->farmingid}}/{{$slide->imageid}}.png" class="image-thumbnail">
                                    </div>
                                    @endif
								</div>
                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div role="tabpanel" class="tab-pane ui-tab-pane @if($index == 0) active @endif" id="description-{{$locale['code']}}">
                                                <textarea class="form-control" rows="4" style="resize:none;" data-plugin="autosize" name="description[{{$locale['code']}}]" data-input-description="{{$locale['code']}}" placeholder="({{trans('_.optional')}})">{!! $slide->getDescription($locale['code']) !!}</textarea>
                                            </div>
                                            @endforeach
                                        </div>
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-9">
                                    ...
                                    <input type="hidden" name="imageid" value="{{$slide->imageid}}" id="ipt-imageid">
