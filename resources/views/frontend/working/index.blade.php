...
<link href="{{ $config['url'] }}/static/frontend/css/working.css" rel="stylesheet" type="text/css">
@endsection

@section('content')
<div class="ui-working" ng-class="{'xs':screen == 'xs'}" ng-controller="WorkingHours">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <div class="head">
                    <div class="line"></div>
                    <div class="title">
                        <span>{{trans('_.Location & Opening hours')}}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-8 wrapper">
                ...
                <div class="row">
                    <div class="col-xs-12">
						<?php
							$embed	= isset($map->{$config['lang']['code']}) ?$map->{$config['lang']['code']}: '';
							$src	= getMapSrc($embed);
						?>
						@if($src != '')
                        <div class="map">
            ...
            <div class="col-md-4">
                <div class="row ui-tour-random">
                    <div class="headline">
                        <div class="line"></div>
                        <div class="title-head"><span>{{trans('_.Booking Tour')}}</span></div>
                    </div>
...
<script src="{{ $config['url'] }}/static/bower_components/angular-nl2br/angular-nl2br.min.js"></script>
<script>
(function(){
    app.requires.push('nl2br');

    app.controller('WorkingHours', function($scope, $filter){
