...
<head>
<meta charset="utf-8">
<title>{{$name}} - {{$e->getStatusCode()}}</title>
        ...
        <div class="row main">
            <div class="col-md-8">
                ...
                <div class="status-code">
                    <i class="fa fa-exclamation-triangle" aria-hidden="true"></i> {{$e->getStatusCode()}}
                </div>
                <div class="status-message">
                    An error occurred
                </div>
                <div class="detail">
                    An error occurred that it could not continue to the page you requested, please check again or try to contact the owner.
                </div>
            </div>
        </div>
        <div class="row">
